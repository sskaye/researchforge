...
# v2.0: removed mp/bp-specific tokens (m.p.=, mp=) from this regex; they
# were the only data-type-specific entries. mp/bp procedure-text contamination
# is now caught by the agent during Phase 2 quote re-confirmation and is
# documented in datatypes/mp_bp/COMMON_ERRORS.md rather than enforced as a
# generic compound-name shape lint.
