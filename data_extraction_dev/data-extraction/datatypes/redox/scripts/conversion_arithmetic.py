...
arithmetically agrees with value.
...
def verify(arith_text, value):
    ...
    if parsed is not None:
        ...
        if abs(result - v_she) > 0.005:
            return False, f"result {result} doesn't match value {v_she}"
...
def main():
    ...
    ap.add_argument("--voltage-col", default="value")
